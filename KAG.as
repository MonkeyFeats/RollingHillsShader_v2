...
void onInit(CRules@ this)
{
	...
	driver.AddShader("raymarch_hills", 1.0f);
	driver.SetShader("raymarch_hills", true);	
	driver.SetShaderFloat("raymarch_hills", "resolutionX", getScreenWidth());
	driver.SetShaderFloat("raymarch_hills", "resolutionY", getScreenHeight());
...
void onTick(CRules@ this)
{
	...
	Driver@ driver = getDriver();
	driver.SetShaderFloat("raymarch_hills", "iTime", getGameTime()*0.002);
}
